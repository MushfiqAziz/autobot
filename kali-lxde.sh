...
wget --tries=20 https://raw.githubusercontent.com/MushfiqAziz/autobot/master/lxde_de.sh -O $folder/root/lxde_de.sh
clear
...
if [ ! -f /root/lxde_de.sh ]; then
    wget --tries=20 https://raw.githubusercontent.com/MushfiqAziz/autobot/master/lxde_de.sh -O /root/lxde_de.sh
    bash ~/lxde_de.sh
else
    bash ~/lxde_de.sh
fi
